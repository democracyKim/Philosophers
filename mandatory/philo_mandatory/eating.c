...
/*   Updated: 2023/06/19 17:51:04 by minkim3          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	pthread_mutex_lock(&philo->resources->last_meal_time[philo->id - 1]);
	philo->last_meal_time = get_time();
	pthread_mutex_unlock(&philo->resources->last_meal_time[philo->id - 1]);
}
